...
#	Why:		Qt (qmake) project file for libcunilog.
#	OS:			-
#	Author:		Thomas
#	Created:	2024-10-12
#  
...
# When			Who				What
# ---------------------------------------------------------------------------------------
# 2025-01-14	Thomas			Created by copying from another qmake project file.
#
#****************************************************************************************

# The name of this project. Makes some code further down more flexible and portable.
#	See https://doc.qt.io/qt-6/qmake-common-projects.html#building-a-library .
#	POSIX platforms prefix the name with implicitely with "lib".
windows:	PROJECTNAME=libcunilog
else:		PROJECTNAME=cunilog
TARGET = $${PROJECTNAME}	# See http://doc.qt.io/qt-5/qmake-variable-reference.html#target .

QT -= gui					# It is a console application.
TEMPLATE = lib

CONFIG += staticlib			# We want to create a static library.
